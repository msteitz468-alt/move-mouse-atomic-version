...
namespace ellabi.Actions
{
    public abstract class ActionBase : INotifyPropertyChanged
    {
        ...
        public enum EventTrigger { Start, Interval, Stop }
        public enum IntervalRepeatMode { Forever, Throttle }
        ...
        {
            get => _name;
            set { _name = string.IsNullOrWhiteSpace(value) ? null : value; OnPropertyChanged(); }
        }
        ...
        public int IntervalThrottle
        {
            ...
            set { _intervalThrottle = value; OnPropertyChanged(); }
        }

        [XmlIgnore] public int IntervalExecutionCount { get; set; }
        [XmlIgnore] public bool InterruptsIdleTime { get; set; }
        [XmlIgnore] public bool Aborted { get; set; }
