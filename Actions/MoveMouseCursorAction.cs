...
namespace ellabi.Actions
{
    public class MoveMouseCursorAction : ActionBase
    {
        ...
        public enum CursorDirection
        {
            ...
            UpAndDown, DownAndUp, LeftAndRight, RightAndLeft
        }

        public enum CursorSpeed { Slow, Normal, Fast, Custom }
        ...
        public int Delay
        {
            ...
            set
            {
                if (_speed == CursorSpeed.Custom) { _delay = value; OnPropertyChanged(); }
            }
        }
        ...
        public override void Execute()
        {
            try
            {
                ...
                int distance = Random
                    ? new System.Random().Next(Distance, UpperDistance)
                    : Distance;
                ...
                switch (Direction)
                {
                    case CursorDirection.Square:
                        ...
                        break;
                    case CursorDirection.North:     mcw.MoveNorth(distance, _delay); break;
                    case CursorDirection.East:      mcw.MoveEast(distance, _delay); break;
                    case CursorDirection.South:     mcw.MoveSouth(distance, _delay); break;
                    case CursorDirection.West:      mcw.MoveWest(distance, _delay); break;
                    case CursorDirection.NorthEast: mcw.MoveNorthEast(distance, _delay); break;
                    case CursorDirection.SouthEast: mcw.MoveSouthEast(distance, _delay); break;
                    case CursorDirection.SouthWest: mcw.MoveSouthWest(distance, _delay); break;
                    case CursorDirection.NorthWest: mcw.MoveNorthWest(distance, _delay); break;
                    ...
                    case CursorDirection.Random:
                        ...
                        while (remaining > 0)
                        {
                            int chunk = new System.Random(remaining).Next(1, Math.Min(remaining, 150));
                            remaining -= chunk;
                            int dir;
                            do { dir = new System.Random().Next(1, 9); } while (dir == lastDir);
                            lastDir = dir;
                            if (mcw.UserActivityDetected) break;
                            switch (dir)
                            {
                                case 1: mcw.MoveNorth(chunk, _delay); break;
                                case 2: mcw.MoveEast(chunk, _delay); break;
                                case 3: mcw.MoveSouth(chunk, _delay); break;
                                case 4: mcw.MoveWest(chunk, _delay); break;
                                case 5: mcw.MoveNorthEast(chunk, _delay); break;
                                case 6: mcw.MoveSouthEast(chunk, _delay); break;
                                case 7: mcw.MoveSouthWest(chunk, _delay); break;
                                case 8: mcw.MoveNorthWest(chunk, _delay); break;
                            }
                        }
                        break;
                    case CursorDirection.None:
                        mcw.MoveFromCurrentLocation(Point.Empty);
                        break;
                }
        ...
        public override string ToString() =>
            $"{GetType().Name} | Name={Name} | Distance={Distance} | Direction={Direction} | Speed={Speed} | Delay={Delay} | Trigger={Trigger} | Repeat={Repeat} | RepeatMode={RepeatMode}";
    }
}
