...
namespace ellabi.Actions
{
    public class PositionMouseCursorAction : ActionBase
    {
        ...
        public TimeSpan CursorTrackingTimeRemaining
        {
            ...
            set { _cursorTrackingTimeRemaining = value; OnPropertyChanged(); }
        }
        ...
        public bool CursorTrackingEnabled
        {
            ...
            set { _cursorTrackingEnabled = value; OnPropertyChanged(); }
        }

        public PositionMouseCursorAction()
        {
            StartCursorTrackingCommand = new RelayCommand(_ => StartCursorTracking());
        }
        ...
        public override void Execute()
        {
            try
            {
                ...
                StaticCode.InputProvider?.MoveTo(X, Y);
            }
            catch (Exception ex)
            {
        ...
        public void StartCursorTracking()
        {
            try
            {
                ...
                _cursorTrackingTimer.Elapsed += OnTrackingTick;
        ...
        private void OnTrackingTick(object? sender, ElapsedEventArgs e)
        {
            try
            {
        ...
        public override string ToString() =>
            $"{GetType().Name} | Name={Name} | X={X} | Y={Y} | Trigger={Trigger}";
    }
}
